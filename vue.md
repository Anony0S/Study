...
- [自动生成路由](https://juejin.cn/post/7294885274174226442?searchId=202403281415407CA3EB8277ABA0FB)：`import.meta.global`导入对应目录下的文件路径
...
bypass(req, _res, options) {
    ...
    // req.setHeader('x-req-proxyUrl', proxyUrl);
},
```
